...
export default function Genarate() {
  ...
  return (
    <div>
      <Layout>
        <div className="boxgg flex justify-center flex-wrap">
          <div className="boxg w-1/2 m-5 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-md mx-auto mt-10">
              <div className="relative">
                <div
                  className={`flex items-center justify-center w-full h-32 border-4 border-dashed border-gray-400 rounded-md cursor-pointer p-4 ${uploadStatus === 'uploading' ? 'opacity-50' : ''
                    }`}
              ...
              <button
                ...
                className={`mt-4 bg-red-400 active:bg-red-100 hover:bg-red-700 text-white font-bold py-2 px-4 rounded ${uploadStatus === 'uploading' ? 'disabled opacity-50' : ''
                  }`}
          ...
          <div className="boxg boxg1 mt-5">
            ...
            <div className="dis overflow-y-auto h-96">
              {selectedImage && (
